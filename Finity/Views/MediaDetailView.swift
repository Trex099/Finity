...
struct MediaDetailView: View {
    ...
    private let relatedItems = [
        MediaItem(id: "R1", name: "The Dark Knight Rises", serverId: nil, type: "Movie", overview: "...", productionYear: 2012, communityRating: 8.4, officialRating: nil, imageTags: ["Primary":"darkknight"], backdropImageTags: nil, userData: nil, genres: nil),
        MediaItem(id: "R2", name: "Batman Begins", serverId: nil, type: "Movie", overview: "...", productionYear: 2005, communityRating: 8.2, officialRating: nil, imageTags: ["Primary":"inception"], backdropImageTags: nil, userData: nil, genres: nil),
        MediaItem(id: "R3", name: "Tenet", serverId: nil, type: "Movie", overview: "...", productionYear: 2020, communityRating: 7.3, officialRating: nil, imageTags: ["Primary":"darkknight"], backdropImageTags: nil, userData: nil, genres: nil),
        MediaItem(id: "R4", name: "Memento", serverId: nil, type: "Movie", overview: "...", productionYear: 2000, communityRating: 8.4, officialRating: nil, imageTags: ["Primary":"inception"], backdropImageTags: nil, userData: nil, genres: nil)
    ]
